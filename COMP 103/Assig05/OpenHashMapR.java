 ...
 * ID: 300069566
 ...
 NOTE:I realise that i haven't finished, but i have written the code for removeKey(),
  but have not fully implemented it in the rest of the methods.
 */

public class OpenHashMapR implements Map {
	...
	public void set(Object key, Object val) {
		...
		//Go through the array until you reasch the end
			if (key.equals(elementData[index].key) && elementData[index].key != null)
	...
	public void removeKey(Object key) {
		...
		while (elementData[index] != null) {
			if (key.equals(elementData[index].key)) {
				Association pair  = elementData[index];
				pair.value = null;
				pair.key = null;
				return;
			}
	...
	private class OpenHashMapEnumerator implements Enumeration {
		...
		public OpenHashMapEnumerator(OpenHashMapR map) {
